          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', padding: '2rem', background: 'var(--surface)', borderRadius: '1.5rem', border: '1px solid var(--border-color)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div>
                ...
                <p style={{ color: 'var(--text-secondary)', margin: 0 }}>technocraftsitsolution@gmail.com</p>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div>
                ...
                <p style={{ color: 'var(--text-secondary)', margin: 0 }}>+91 9373052998</p>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div>
                ...
                <p style={{ color: 'var(--text-secondary)', margin: 0 }}>Nashik, Maharashtra <br />Innovation City, Nashik</p>
              </div>
            </div>
          </div>
